...
--[[---------------------------------------------------------
	PlayerHairColor Material Proxy
		Sets the clothing colour of custom made models to
		ent.GetPlayerHairColor, a normalized vector colour.
-----------------------------------------------------------]]
...
matproxy.Add( {
	...
	bind = function( self, mat, ent )
		...
		-- If the target ent has a function called GetPlayerHairColor then use that
